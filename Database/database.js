...
export class DatabaseSchema {
  constructor() {}
  SupaUser(attributes) {
    return new SupabaseUser(attributes);
  }
  EventGoUser(attributes) {
    return new EventGoUser(attributes);
  }
  User(attributes) {
    return new CombinedUser(attributes);
  }
  Business(attributes) {
    return new EventGoBusiness(attributes);
  }
  Transaction(attributes) {
    return new Transaction(attributes);
  }
  Show(attributes) {
    return new Show(attributes);
  }
  Ticket(attributes) {
